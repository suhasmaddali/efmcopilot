...
def read_and_display_latest_file(directory, prefix="ATD_Final_DSHBRD_BUF_SELLIN_", encoding="utf-8"):
...
latest_df_file = read_and_display_latest_file(directory_path, encoding="ISO-8859-1")
